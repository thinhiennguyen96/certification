...
def calculate_demographic_data(print_data=True): 
    df = pd.read_csv('adults.data.csv')
    
    race_count = df['race'].value_counts()
    
    averange_age_men = round(df.groupby('sex')['age'].mean('Male'), 1)
    ...
    if print_data:
        ...
        print('Average age of men:', averange_age_men)
    ...
    return {
        ...
        'averange_age_men' : averange_age_men,
        'percentage_bachelors' : higher_education,
